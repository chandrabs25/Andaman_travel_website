...
export default function Home() {
  ...
  const popularActivities = [
    { id: 1, name: 'Scuba Diving', image: '/images/scuba.jpg', description: 'Explore vibrant coral reefs and marine life', },
    { id: 2, name: 'Sea Walking', image: '/images/sea-walking.jpg', description: 'Walk on the ocean floor with specialized equipment', },
    { id: 3, name: 'Trekking', image: '/images/trekking.jpg', description: 'Trek through the lush forests of Andaman and discover hidden waterfalls.', },
    { id: 4, name: 'Glass Bottom Boat Ride', image: '/images/glass-boat.jpg', description: 'View the colorful coral reefs and marine life without getting wet.', },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative"> {/* Keep relative positioning here */}

        {/* Image & Overlays Wrapper */}
        <div className="relative h-[450px] sm:h-[550px] md:h-[600px] w-full"> {/* Adjusted height slightly */}
          {/* Background overlays */}
          ...
          <div className="absolute inset-0 z-0">
            ...
            {/* Mobile Image */}
            <Image
              // Assuming you might want a different mobile image later
              src="/images/hero-mobile.jpg" // Your mobile-specific image (CREATE THIS IMAGE if different)
              // If using the same image: src="/images/hero.PNG"
          ...
          {/* Text Content Overlay - Positioned within the image container */}
          <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center relative z-20 text-center pb-24 md:pb-32"> {/* Added padding-bottom */}
             <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-3 md:mb-6"> Discover Paradise in Andaman </h1>
             <p className="text-base sm:text-lg md:text-xl text-white max-w-2xl"> Explore pristine beaches, vibrant coral reefs, and unforgettable experiences. </p>
          </div>
        </div>

        {/* Search Form - Positioned absolutely on desktop, relative below on mobile */}
        {/* Removed container here, applying it inside */}
        <div className="absolute bottom-8 left-0 right-0 px-4 z-30 md:bottom-10 lg:bottom-12"> {/* Position absolutely on desktop */}
           <div className="container mx-auto"> {/* Re-added container for centering */}
             <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 w-full max-w-4xl mx-auto"> {/* Max width and margin auto */}
      ...
      {/* Content Below Hero */}
      {/* Add padding-top here to account for the form moving down on mobile */}
      <div className="pt-16 md:pt-0"> {/* Only add padding top on mobile */}
      ...
      </div> {/* End Content Below Hero Wrapper */}
    </div> // End Main Div
  );
}